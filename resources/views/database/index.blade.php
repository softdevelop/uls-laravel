@extends('app')
@section('title')
	{{trans('cms_database/database-index.title')}}
@stop
@section('content')
...
@section('script')
    ...
    <script>
		window.idOfDatabaseSelected = {!! json_encode($idOfItemSelected) !!};
	</script>
	...
	@if(!isProduction() && !isDev())
		...
		{!! Html::script('app/components/accessories/accessoriesService.js?v='.getVersionScript())!!}
	...
	@else
		<script src="{{ elixir('app/pages/database.js') }}"></script>
