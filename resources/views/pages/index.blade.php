@extends('app')
@section('title')
	{{trans('cms_page/page-index.content_management')}}
@endsection
@section('content')
...
@section('script')
	...
	<script>
		window.hashData = {!! json_encode($hashData) !!};
		window.idOfPageSelected = {!! json_encode($idOfItemSelected) !!};
		window.status = {!! json_encode($status) !!};
		window.clickUpdate = {!! json_encode($clickUpdate) !!};
	</script>
