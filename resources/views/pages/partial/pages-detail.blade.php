...
<div class="visible-sm visible-xs" ng-if="isDetails">
    ...
    <div class="form-group">
        <label class="control-label hightlight-lb" for="template">{{trans('cms_page/page-detail.name')}}:<small class="text-require"> *</small></label>
        <input class="form-control" name="name" ng-model="page.name" ng-disabled ="isDisable" type="text"
                ...
                ng-required="true"/>
        <div class="pull-left">
            <small class="help-inline" ng-show="submitted && formData.name.$error.required">{{trans('cms_page/page-detail.name_required')}}.</small>
            <small class="help-inline" ng-show="submitted && pageNameUnique">{{trans('cms_page/page-detail.name_existed')}}.</small>
            <small class="help-inline" ng-show="submitted && formData.name.$error.maxlength">{{trans('cms_page/page-detail.name_max_length')}}</small>
        </div>
    </div>

    <!-- Parent -->
    <div class="form-group">
        <label class="control-label hightlight-lb" for="template">{{trans('cms_page/page-detail.type')}}</label>
    ...
    <div class="form-group">
        ...
        <label class="control-label hightlight-lb" for="template">{{trans('cms_page/page-detail.url')}}:<small class="text-require"> *</small></label>

        <div class="input-group full-width">
          {{-- <span class="fix-addon input-group-addon" ng-if="page.parent_id!=0&&page.parent_id" id="basic-addon3">/@{{parents[page.parent_id]}}/</span> --}}
        ...
        <div class="pull-left">
            <small class="help-inline" ng-show="submitted && formData.url.$error.required">{{trans('cms_page/page-detail.url_required')}}.</small>
            <small class="help-inline" ng-show="submitted && pageUrlUnique">{{trans('cms_page/page-detail.url_existed')}}.</small>
            <small class="help-inline" ng-show="submitted && errorTypeUrl">{{trans('cms_page/page-detail.url_invalid')}}</small>
            <small class="help-inline" ng-show="submitted && formData.url.$error.maxlength">{{trans('cms_page/page-detail.url_maxlength')}}</small>
        </div>
    </div>
   <!-- Input Template-->
    <div class="form-group">
        ...
        <label class="hightlight-lb" for="template">
            {{trans('cms_page/page-detail.template')}}
        ...
        <select name="template" class="form-control" ng-disabled ="isDisable" ng-model="page.template" ng-change="changeTemplate(page.template)" id="template" ng-options="key as value.name for (key, value) in templates">
          <option disabled="true" value="">{{trans('cms_page/page-detail.select_a_template')}}</option>
        </select>
    ...
    <div class="form-group">
        ...
        <label class="hightlight-lb" for="version">
            {{trans('cms_page/page-detail.version')}}
            <!--: <span class="text-require"> *</span> -->
        </label>
