@extends('app')
@section('title')
    {{ trans('Permission/permission-index.breadcrum') }}
@stop
@section('content')

<div data-ng-controller="PermissionController">
    <div class="top-content">
        <label class="c-m">{{ trans('Permission/permission-index.breadcrum') }}
            <a data-toggle="modal" ng-click="defaultContentModal()" data-target=".bs-example-modal-lg">
                <i title="Help Information" class="fa fa-info-circle help-infor-icon"></i>
            </a>
        </label>
        <a data-toggle="modal" href="javascript:void(0)" ng-click="getModalCreatePermission()" class="btn btn-primary pull-right fix-btn-top-content hidden-xs">
            <i class="fa fa-plus"></i> &nbsp {{ trans('Permission/permission-index.add_permission') }}
        </a>

        <a data-toggle="modal" href="javascript:void(0)" ng-click="getModalCreatePermission()" class="btn btn-primary pull-right fix-btn-top-content visible-xs">
            <i class="fa fa-plus"></i> &nbsp {{ trans('Permission/permission-index.add') }}
        </a>
    </div>
    <div class="content">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                   ...
                   <h4 class="modal-title">Permission Administration</h4>
                </div>
                ...
                <div class="modal-body modal-user">
                    ...
                    <div class="col-lg-4 col-md-4 help-infor-modal hidden-sm-down">
                        ...
                        <ul class="fixed-ul-user">
                            <li> <a class="f700" data-toggle="collapse" href="#collapseAd" aria-expanded="false" aria-controls="collapseExample">User Administration</a>
                                <ul class="session-user-admin ls-none collapse" id="collapseAd">
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('ad-access')">Access</a></li>
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('ad-users')">Users</a></li>
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('ad-search-users')">Search Users</a></li>
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('ad-edit-user-profile')">Edit User Profile</a></li>
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('ad-add-user')">Add User</a></li>
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('ad-update-permission')">Update Permissions</a></li>
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('ad-password-reset')">Password Reset</a></li>
                            ...
                            <li><a class="f700" data-toggle="collapse" href="#collapseRoles" aria-expanded="false" aria-controls="collapseExample">Roles</a>
                                <ul class="session-roles ls-none collapse" id="collapseRoles">
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('roles-access')">Access</a></li>
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('roles-edit-role-permissions')">Edit Role Permissions</a></li>
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('roles-edit-role-user-groups')">Edit Role Users and Groups</a></li>
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('roles-edit-role-details')">Edit Role Details</a></li>
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('roles-delete-a-role')">Delete a Role</a></li>
                                </ul>
                            </li>
                                
                            <li><a class="f700" data-toggle="collapse" href="#collapsePermission" aria-expanded="false" aria-controls="collapseExample">Permissions</a>
                                <ul class="session-permissions ls-none collapse in" id="collapsePermission">
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('per-access')">Access</a></li>
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('per-edit-per-user-group')">Edit Permission Users and Groups</a></li>
                                    <li><a href="javascript:void(0)" ng-click="goToAnchorWithId('per-edit-per-details')">Edit Permission Details</a></li>
                                    <li><a  href="javascript:void(0)" ng-click="goToAnchorWithId('per-delete-a-per')">Delete a Permission</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="col-lg-8 col-md-8">
                        <h4 id="user-administration" class="c-primary">User Administration</h4>
                        <div class="space-area user-ad-area">
                            ...
                            <strong id="ad-access">Access</strong>
                            <div class="m-b-20">
                                Access the User Administration page by selecting  <strong>Users</strong> from the Administration/Users section of the Left Navigation menu.
                            </div>
                            <div class="m-b-20">
                            ...
                            <strong id="ad-users">Users</strong>
                            <div class="m-b-20">
                            ...
                            <strong id="ad-search-users">Search Users</strong>
                            <div class="m-b-20">
                            ...
                            To add a new user, click the <strong>Add User</strong> button on the top right of the User Administration page and then enter the user’s first and last names, email address, and phone number.
                            ...
                            <strong id="ad-update-permission">Update Permissions</strong>
                            <div class="m-b-20">
                                Update a user’s Role, Permissions, and/or Group by selecting <strong>Update Permissions</strong> from the <strong>Action</strong> menu for that user.
                            ...
                            <div class="m-b-20">Learn more about creating and managing <a id="tag-roles" href="javascript:void(0)" ng-click="goToAnchorWithId('container-roles')" class="c-primary-h">Roles</a> and <a id="tag-permission" href="javascript:void(0)" ng-click="goToAnchorWithId('container-permission')" class="c-primary-h">Permissions</a> in those sections of this Help guide. </div>

                            <strong id="ad-password-reset">Password Reset</strong>
                            <div class="m-b-20">Initiate a password reset in cases of lost or forgotten passwords by selecting <strong>Password Reset</strong> from the <strong>Action</strong> menu for that user.
                        ...
                        <div class="space-area roles-area">
                            ...
                            <strong id="roles-access">Access</strong>
                            ...
                            <strong id="roles-edit-role-permissions">Edit Role Permissions</strong>
                            ...
                            <strong id="roles-edit-role-user-groups">Edit Role Users and Groups</strong>
                                <div>
                                ...
                                <strong id="roles-edit-role-details">Edit Role Details</strong>
                                <div class="m-b-20">
                                ...
                                <strong id="roles-delete-a-role">Delete a Role</strong>
                                <div>
                        ...
                        <h4 id="container-permission" class="m-t-30 c-primary">Permissions</h4>
                        <div class="space-area permission-area">
                            ...
                            <strong id="per-access">Access</strong>
                            <div class="m-b-20">
                                Roles are groups of Permissions that can be associated to a user or to groups of users.
                                Access the Permission Administration page by selecting <strong>Permissions</strong> from the Administration/Users section of the Left Navigation menu.
                            ...
                            <strong id="per-edit-per-user-group">Edit Permission Users and Groups</strong>
                            ...
                            <strong id="per-edit-per-details">Edit Permission Details</strong>
                            <div>
                            ...
                            <strong id="per-delete-a-per">Delete a Permission</strong>
...
@section('script')
    @if(!isProduction() && !isDev())
        ...
        {!! Html::script('app/components/permission/permissionEditorController.js?v='.getVersionScript())!!}
