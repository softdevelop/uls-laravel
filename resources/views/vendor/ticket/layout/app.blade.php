                                    ...
                                    <div data-scrollable>
                                        ...
                                        @if(\Auth::check())
                                            @if(\Auth::user()->hasRole('super_admin') || \Auth::user()->hasPerm('user_admin'))
                                                <li class="active"><a href="/admin/user"><i class="fa fa-user"></i> <span>User</span></a>
                                                </li>
                                            @endif
                                            @if(\Auth::user()->hasRole('super_admin'))
                                                ...
                                                <li><a href="/admin/data-option"><i class="fa fa-magic"></i> <span>Data Option</span></a>
                                                </li>
                                                <li><a href="/support/type"><i class="fa fa-magic"></i> <span>Type</span></a>
                                                </li>
                                            @endif
                                                <li><a href="/support"><i class="fa fa-magic"></i> <span>Ticket</span></a>
                                                    <ul>
                                                        @foreach (MenuService::listMenuIwanTo() as $menu)
                                                            <li @if(Request::is('support/new/{{$menu->alias}}')) class="active" @endif>
                                                                <a title="{{$menu->name}}" href="support/new/{{$menu->alias}}"><i class="fa fa-circle-o"></i> <span>{{$menu->name}}</span></a>
                                                            </li>
                                                        @endforeach
