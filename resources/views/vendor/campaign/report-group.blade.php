		...
		<form name="formSearchByDate" novalidate>
			<div class="tile-title">
	            ...
	            <div class="search-day col-sm-12 col-md-2 col-lg-4 form-group">
	            	<button ng-disable="isLoading" class="btn btn-primary" ng-click="getSearchModalAds('search-report-group', formSearchByDate.$invalid)">Search</button>
            ...
            <table ng-show="!isLoading" class="table table-bordered report-campaign center-td" ng-table="tableParams">
			    <tbody>
				    <tr ng-repeat="campaign in $data">
		                ...
		                <td sortable="'name'" data-title="'Name'" class="text-left name"><a href="/campaign/report-ads/@{{campaign['groupId']}}">@{{campaign['name']}}</td>
