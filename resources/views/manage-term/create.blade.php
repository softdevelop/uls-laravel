...
<div class="roles-wrap wrap-branch" data-ng-controller="ModalManageTermCtrl"> 
    <div class="tab-content">
        ...
        <form method="POST" class="css-form" accept-charset="UTF-8" name="formData" ng-init="term={{json_encode($term)}}; getData()">
                ...
                <div ng-repeat="filed in fileds" class="col-lg-@{{filed.value['col']}} @{{filed.value.alias}} padding-none" ng-class="{'has-error': submitted && formData.@{{filed.attrName}}.$invalid}">    
                    ...
                    <legend ng-if="term.fields[$index].modal" class="p-0-15">
                        <strong class="f13">Add @{{filed.name}}</strong> 
        ...
        <div class="m-15-30">
            <button id="bt-submit" class="btn btn-primary pull-right" ng-click="submit(formData)"><i class="fa fa-check"></i> Save</button>
            <div class="clearfix"></div>
        </div>
