...
guideConfigurator.controller('GuideConfiguratorController', ['$scope', '$modal', 'GuideConfiguratorService', 'ConfiguratorService', '$timeout', '$filter', 
    ...
    var setDefaultAnserQuestion = function () {
        if (angular.isDefined($scope.dataInput.answerQuestions.question_first)) return;
...
guideConfigurator.controller('EmailController', ['$scope', 'dataInput', '$modalInstance', function ($scope, dataInput, $modalInstance) {
