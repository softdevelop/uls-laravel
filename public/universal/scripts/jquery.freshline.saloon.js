...
(function($,undefined){	
	...
	$.fn.extend({
		...
		var defaults = {	
			...
			///////////////////////
			// ROTATE THE SLIDES //background-color:#000000;
			///////////////////////
			function rotateSlides(main,opt) {
				...
				if (main.find('.canvas-go').length==0) {
					...
					main.append('<div class="blackbox-go" style="z-index:13;position:absolute;left:1px;top:1px;;width:'+(opt.width-2)+'px;height:'+(opt.height-2)+'px"></div>');
					
					main.append('<div><img class="canvas-come" style="position:absolute;left:0px;top:0px;z-index:1" src=""></div>');
					main.append('<div class="blackbox-come" style="z-index:11;position:absolute;left:1px;top:1px;width:'+(opt.width-2)+'px;height:'+(opt.height-2)+'px"></div>');
				}
