								...
								<div class="pp_content"> \
									...
									<div class="pp_fade"> \
										...
										<div class="pp_details clearfix"> \
																<a class="pp_close" onClick="_gaq.push([\'_trackEvent\', \'Lightbox\', \'Closes\',\''+$(this).attr('href')+'\']);" href="#">Close</a> \
										</div> \
									</div> \
								</div> \
							</div> \
			...
			$pp_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(pp_images[setPosition])){
					...
					case 'youtube':
						...
						if(settings.autoplay) movie += "&modestbranding=1&version=3&hl=en_US&rel=0&autoplay=1&color=white&controls=0";
