...
class CreateTicketEmail extends Job implements SelfHandling, ShouldQueue
{
    ...
    {
        // event(new BroadcastTicketCreated($this->ticket, $this->user));

        $notification = new Notification();
        $notification->pushNotificationCreateTicket($this->ticket, $this->user);
    }
}