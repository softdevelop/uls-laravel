...
class RemoveFieldsInvaldInPage extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cms:update_content_page';
    ...
    public function handle()
    {
        ...
        foreach ($allPage as $keyPage => $page) {
            //check current page
            //it exist data and that data is empty?
            //then, check data of page exist field and that field is empty?
            if (isset($page['data']) && !empty($page['data']) && isset($page['data']['fields']) && !empty($page['data']['fields'])) {
                $fieldValueOfPage = $page['data']['fields'];
                ...
                $page['data.fields'] = $fieldValueOfPage;
