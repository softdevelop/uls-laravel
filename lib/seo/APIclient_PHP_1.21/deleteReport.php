<?php
    ...
    */
    ...
    $timestamp=time();
    $format='xml';//Output Format. deleteReport supports the following formats: xml and json
    //$format='json';
    ...
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, 'http://www.webseoanalytics.com/api/1.2/deleteReport.php');
