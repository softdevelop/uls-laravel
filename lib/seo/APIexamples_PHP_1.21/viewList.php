...
// <![CDATA[
    function viewList() {
        location.href='viewList.php?toolID='+document.getElementById('toolID').value;
    }
// ]]>     
</script><br /><br />
<?php
    ...
    */
    ...
    $result=$WSAclient->viewList($toolID,WSA_SUBSCRIPTION_ID,'xml','EN');

    unset($WSAclient);
    
    
    echo WSAParser::viewListResponse($result);
